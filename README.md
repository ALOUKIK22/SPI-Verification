...
Project Highlights
SPI Master RTL implemented in Verilog
...
spi_cs_l goes low during transfer and returns high after completion.
Exactly 8 SCLK pulses are generated.
MOSI transmits Most Significant Bit (MSB) first.
Errors Made During RTL Design
...
Master was sending data correctly:

spi_sclk generated correctly
MOSI shifted correctly
tx_shift shifted correctly
...
SPI Master controller using FSM
Shift register-based serial transmission
8-bit data transfer
Controlled chip select (spi_cs_l)
Clock-driven shifting mechanism
Tools Used-
Verilog HDL
